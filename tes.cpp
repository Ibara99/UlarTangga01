...
float * vektor (float x1,float y1,float z1,
...
float * vektor_normal (float x1,float y1,float z1,
    ...
    */
    float* v_normal;
    float* v1 = vektor(x1,y1,z1,x2,y2,z2);
    float* v2 = vektor(x1,y1,z1,x4,y4,z4);

    //kulupa cara nyarinya. nunggu dapet hidayah (ppt) dari pak yo
