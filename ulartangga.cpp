...
// mode
        ...
        if (mode==1){
            ...
            spin_observer[0]=spin_ob_save[0]; spin_observer[1]=spin_ob_save[1]; spin_observer[2]=spin_ob_save[2];
            mode=2;
        }else if (mode==2){
            spin_save[0]=spin[0]; spin_save[1]=spin[1]; spin_save[2]=spin[2];
            spin[0] = 0; spin[1]=0; spin[2]=0;
            spin_ob_save[0]=spin_observer[0]; spin_ob_save[1]=spin_observer[1]; spin_ob_save[2]=spin_observer[2];
            spin_observer[0] = 0; spin_observer[1]=0; spin_observer[2]=0;
            mode=3;
        }else{
            spin[0] = 0;
            mode=1;
